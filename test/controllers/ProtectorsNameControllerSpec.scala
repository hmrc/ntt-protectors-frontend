...
import forms.ProtectorsNameFormProvider
import matchers.JsonMatchers
import models.{NormalMode, ProtectorsName, UserAnswers}
...
class ProtectorsNameControllerSpec extends SpecBase with MockitoSugar with NunjucksSupport with JsonMatchers {
  ...
  "ProtectorsName Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, protectorsNameRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val application = applicationBuilder(userAnswers = Some(emptyUserAnswers)).build()
      val request = FakeRequest(POST, protectorsNameRoute).withFormUrlEncodedBody(("value", "invalid value"))
