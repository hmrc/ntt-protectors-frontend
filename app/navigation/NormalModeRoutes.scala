...
import pages.{DoYouKnowProtectorDateOfBirthPage, DoYouKnowTheirNationalityPage, Page, ProtectorDateOfBirthPage, ProtectorNationalityPage, ProtectorTypePage, ProtectorsNamePage}
